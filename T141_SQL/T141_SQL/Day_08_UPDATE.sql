...
CONSTRAINT idIsim_primary PRIMARY KEY(id,isim)
);
...
-- Iletisim ismi 'Osman Can' olan firmanin iletisim ismini 'Elif Can' olarak guncelleyiniz.


UPDATE firmalar
SET iletisim_isim='Elif Can'
...
(
    ...
    CONSTRAINT tedatikciID_fk FOREIGN KEY(tedarikci_id)
...
/*
UPDATE urun
SET urun_ismi = -- tedarik tablosunda irtibat Merve Temiz olan sirketin ismi
...
-- urun id'si 1001 olan urun ismini, id'si 102 olan sirketin ismi 
-- ile degistirin.
...
-- Tum cocuklarin veli isimlerini 
-- puanlar tablosundaki ders_adi ile update edin.
