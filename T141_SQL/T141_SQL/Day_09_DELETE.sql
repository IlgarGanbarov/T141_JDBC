...
SAVEPOINT baslangic;    -- Database verilerini yedekler

DELETE FROM cocuk;

SELECT * FROM cocuk;

ROLLBACK TO baslangic;  -- Database'e yedeklenen verileri geri cagirir.
...
-- DROP ve TRUNCATE islemelri datalar ile birlikte SAVEPOINT¡'i de siler.
...
WHERE id> 125;
 ...
 -- Parent Child iliskisi icerisindeki tablolardan veri silinirken 
 -- once Child sonra Parent table dan verinin silinmesi gerekir.
