...
*/
 ...
 SELECT SUM(satis_miktari) toplam_satis
 FROM satis_raporu;
...
SELECT SUM(satis_miktari * birim_fiyati) AS total_gelir_laptop
FROM satis_raporu
...
SELECT SUM(satis_miktari * birim_fiyati) AS toplam_satis_geliri
FROM satis_raporu
...
SELECT AVG(birim_fiyati) ort_birim_fiyat
FROM satis_raporu;
...
SELECT AVG(satis_miktari) ort_satıs_mıktarı
FROM satis_raporu
...
*/ 
 ...
 SELECT MIN(birim_fiyati) birim_fiyati
 FROM satis_raporu;
...
SELECT MAX(satis_tarihi), MIN(satis_tarihi)
FROM satis_raporu;
